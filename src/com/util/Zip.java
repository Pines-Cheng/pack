...
public class Zip {
	 ...
	 * @throws IOException
	 */
	public static boolean zipIt(String zipFile, String sourceFolderString)
			throws IOException {

		File sourceFolder = new File(sourceFolderString);
		FileOperate.ifFileNotExistThenCreate(sourceFolderString);

		List<String> fileList = new ArrayList<String>();
		Zip.generateFileList(sourceFolder, sourceFolderString, fileList);
		...
		try {
			...
			for (String file : fileList) {
				...
				// 获取文件输入流，读文件
				FileInputStream in = new FileInputStream(sourceFolderString
						+ File.separator + file);
